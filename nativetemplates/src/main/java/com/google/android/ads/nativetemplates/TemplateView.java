...
public class TemplateView extends FrameLayout {
  ...
  private void applyStyles() {
    ...
    String mainBackground = styles.getMainBackgroundColor();
    if (mainBackground != null) {
      background.setBackground(Drawable.createFromPath(mainBackground));
      if (primaryView != null) {
        primaryView.setBackground(Drawable.createFromPath(mainBackground));
      }
      if (secondaryView != null) {
        secondaryView.setBackground(Drawable.createFromPath(mainBackground));
      }
      if (tertiaryView != null) {
        tertiaryView.setBackground(Drawable.createFromPath(mainBackground));
      }
    }
